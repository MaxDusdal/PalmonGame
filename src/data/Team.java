...
public class Team implements Serializable {
     ...
     *               Time Complexity: O(1)
     *               Reasoning: Adding an element to an ArrayList is an O(1)
     *               operation, assuming the list does not need to resize.
     */
     ...
     *         Reasoning: The method iterates through the list of Palmoms to check
     *         if each one is defeated.
     */
